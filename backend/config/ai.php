    ...
    */
    ...
    'providers' => [
        'anthropic' => [
            ...
            // Model default paket adalah claude-sonnet-5; SIGULA memakai Opus 5
            // untuk ringkasan karena analisisnya menyangkut angka keuangan.
            'models' => [
                'text' => [
                    'default' => env('ANTHROPIC_MODEL', 'claude-opus-5'),
                ],
            ],
        ...
        'gemini' => [
            ...
            'models' => [
                'text' => [
                    'default' => env('GEMINI_MODEL', 'gemini-3.7-flash'),
                ],
            ],
